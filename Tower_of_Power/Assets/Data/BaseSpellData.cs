...
public class BaseSpellData : ScriptableObject
{
	...
	[Range(0, 20)]
	public int ManaCost;
	public UnitData SummonData;

	[Header("Spell Effects")]
	public SpellEffect[] SpellEffects;

	[Header("Crafting Variables")]
    public CraftingResource ResourceOne;
	[Range(1, 12)]
	public byte ResourceOneAmount;
	public CraftingResource ResourceTwo;
	[Range(1, 12)]
	public byte ResourceTwoAmount;
}
